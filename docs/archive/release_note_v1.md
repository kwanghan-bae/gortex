# 📦 Gortex Release Notes Archive (v1.x)

이 문서는 Gortex v1.0.0부터 v1.9.9까지의 초기 개발 기록을 담고 있습니다. 최신 기록은 `docs/release_note.md`를 참고하세요.
...
- [x] `agents/planner.py`: 시스템 설계 시 Mermaid 형식의 다이어그램 코드를 생성하는 `diagram_code` 필 및 지침 추가
